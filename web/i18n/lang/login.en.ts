const translation = {
  ...
  welcome: 'Welcome to My-Buddy.AI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting My-Buddy.AI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on My-Buddy.AI',
  invalid: 'The link has expired',
  explore: 'Explore My-Buddy.AI',
