const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'My-Buddy.AI account',
    langGeniusAccountTip: 'Your My-Buddy.AI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to My-Buddy.AI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by My-Buddy.AI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across My-Buddy.AI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'My-Buddy.AI {{version}} is now available.',
